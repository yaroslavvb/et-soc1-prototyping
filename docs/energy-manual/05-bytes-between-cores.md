...
**What the tables say.**
- **Between the two minions of a pair a byte costs under a picojoule** (0.67 pJ); around a neighbourhood or a shire about 2.1 pJ; across the mesh 12–18 pJ: about 9 pJ to leave the shire plus 1.7 pJ per mesh hop (a straight line through the six 1 KB rings between shires against their mean distances of 1.6–4.7 hops, r² 0.95; [Heat per millimetre](https://spacesheep.dev/@yaroslavvb/et-soc1-heat-per-mm) measures 1.5 pJ/B per hop on the mesh rail and 2.2 on board power directly). **Leaving the shire is the biggest single step, but the hops after it are not free.**
...
- The three relay bars are ±4–8% because each is a 4–5 W signal over a board idle that drifts; the DRAM relay's power also rides on a path with no rail sensor.
