...
| 1,024 minions stalled on one contended atomic (the hot line, E23; each waits about 10,000 cycles for its turn) | — | a2 only, 22 September | 1.41 | 1.4 mW | — |
...
**Rules.** An awake minion costs about 2 mW; a second hart adds about 1 mW; a minion stalled on a contended atomic draws less than one spinning (1.4 against 2.1 mW). Keeping 1,024 minions awake for a second is 2–3.5 J, against 36 J for the card at 80 °C, so the awake cost is small next to leakage and next to real instructions.
